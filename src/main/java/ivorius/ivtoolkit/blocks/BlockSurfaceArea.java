...
public class BlockSurfaceArea implements Iterable<BlockSurfacePos>
{
    ...
    public static BlockSurfaceArea from(AxisAlignedBB boundingBox)
    {
    ...
    public AxisAlignedBB toStructureBoundingBox(int minY, int maxY)
    {
        BlockSurfacePos lower = getLowerCorner();
        BlockSurfacePos higher = getHigherCorner();
        return new AxisAlignedBB(lower.getX(), minY, lower.getZ(), higher.getX(), maxY, higher.getZ());
    }
}